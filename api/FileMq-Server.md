...
### bind
    ...
    boolean FileMq\Server::bind(string|array $endpoint)
...
### send_picture
    ...
    mixed FileMq\Server::send_picture(string $picture)
...
### send_bson
    ...
    mixed FileMq\Server::send_bson(mixed $data)
