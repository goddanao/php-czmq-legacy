...
public:
    ...
    static Php::Value pub(Php::Parameters &param) { return new_socket_php("pub", param); }
    static Php::Value sub(Php::Parameters &param) { return new_socket_php("sub", param); }
    static Php::Value rep(Php::Parameters &param) { return new_socket_php("rep", param); }
    static Php::Value req(Php::Parameters &param) { return new_socket_php("req", param); }
    static Php::Value dealer(Php::Parameters &param) { return new_socket_php("dealer", param); }
    static Php::Value router(Php::Parameters &param) { return new_socket_php("router", param); }
    static Php::Value push(Php::Parameters &param) { return new_socket_php("push", param); }
    static Php::Value pull(Php::Parameters &param) { return new_socket_php("pull", param); }
    static Php::Value xpub(Php::Parameters &param) { return new_socket_php("xpub", param); }
    static Php::Value xsub(Php::Parameters &param) { return new_socket_php("xsub", param); }
    static Php::Value xreq(Php::Parameters &param) { return new_socket_php("xreq",  param); }
    static Php::Value xrep(Php::Parameters &param) { return new_socket_php("xrep", param); }
    static Php::Value stream(Php::Parameters &param) { return new_socket_php("stream",  param); }
