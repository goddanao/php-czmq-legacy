...
public:
    ...
    MalamuteClient() : ZActor("mlm_client", &MalamuteClient::new_actor), Php::Base() { }
    MalamuteClient(mlm_client_t *handle, bool owned) : ZActor(handle, owned, "mlm_client", &MalamuteClient::new_actor), Php::Base() { }
